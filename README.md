...
Total runtime:
Ranking for 50 stars: 2871st place
...
many straight moves since last turn) to check if a node was visited was enough. Same solution for both parts.
...
* Topics: Graph, Pathfinding, Bellmann-Ford (?)
